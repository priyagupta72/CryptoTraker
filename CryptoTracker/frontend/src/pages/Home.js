...
//       <div>
//         <main className="text-gray-900 bg-gray-100 min-h-screen py-10 px-4 sm:px-6 lg:px-8">
//           <section className="pt-40 md:pt-20">
//             <div className="container mx-auto px-8 lg:flex">
//               <div className="text-center lg:text-left lg:w-1/2">
//                 <h1 className="text-4xl lg:text-5xl xl:text-6xl py-6 font-bold leading-none">
...
//                   <button
//                     type="button"
//                     className=" py-4 px-12 bg-green-700 rounded text-white"
//                   >
//                     Log in to explore
//                   </button>
//                   </Link>
...
const Home = () => {
  return (
    <>
      <div>
        <main className="text-gray-100 bg-[#0d1117] min-h-screen py-12 px-6 sm:px-10 lg:px-16">
          <section className="pt-36 md:pt-20">
            <div className="container mx-auto px-6 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                <h1 className="text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-tight text-[#00FFEA]">
                  Welcome to CryptoTracker
                </h1>
                <p className="text-lg lg:text-xl mt-6 font-light text-gray-300">
                  Your ultimate destination for tracking cryptocurrency prices and trends. Stay ahead with real-time data and insights.
                </p>
                <p className="mt-8">
                  <GuestSection>
            ...
            <div className="container mx-auto text-center">
              ...
              <div className="flex flex-col  sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  <div
                    className="p-12 rounded-lg border border-solid border-gray-200 mb-8  bg-green-500"
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
                  >
                    <p className="font-semibold text-xl">Top 10</p>
                    <p className="mt-4">
                    "Stay ahead of the market with our Top 10 section, featuring the leading cryptocurrencies by market capitalization. This curated list highlights the top performers, showcasing their current prices, percentage changes, and trading volumes. Easily track the most influential assets and spot emerging trends to make informed investment decisions. The Top 10 section offers a snapshot of the most impactful cryptocurrencies, helping you stay on top of the latest market movements."
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    "Explore the Trending section to find the most rapidly moving cryptocurrencies and key market developments. This section highlights assets with significant price changes, surging trading volumes, or notable news events driving interest. Stay informed about the latest trends and market shifts to identify potential opportunities and make timely investment decisions. The Trending section keeps you up-to-date with the dynamic and fast-paced world of cryptocurrency."
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                    "Track and manage your favorite cryptocurrencies with ease using the Watchlist. Add any coins or tokens you're interested in to keep an eye on their performance and market trends. Customize alerts for price changes, volume spikes, and other key metrics to stay informed and make timely investment decisions. Your Watchlist provides a personalized snapshot of the crypto assets you care about most, helping you to make smarter, data-driven choices."
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col justify-between">
          ...
          <Link
            to="/trending"
            className="text-green-500 hover:text-green-700 font-semibold transition-transform duration-300 transform hover:scale-105"
          >
            Learn More
          </Link>
        </div>
        ...
        <div className="bg-white p-6 flex flex-col justify-between rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
          ...
          <section className="bg-green-500 text-white text-center py-12 rounded-lg shadow-lg">
        ...
        <Link to="/signin">
          <button className="bg-green-800 hover:bg-green-900 text-white font-semibold py-3 px-6 rounded-lg text-lg transition-transform duration-300 transform hover:scale-105">
            Sign Up for free
          </button>
        </Link>
      </section>
...
<section id="features" className="py-20 lg:pb-40 lg:pt-36">
            <div className="container mx-auto text-center">
              <h2 className="text-4xl lg:text-5xl font-bold text-[#00FFEA]">
                Main Features
              </h2>
                ...
                {[
                  {
                    title: "Top 10",
                    description:
                      "Stay ahead of the market with our Top 10 section, featuring the leading cryptocurrencies by market capitalization.",
                  },
                  {
                    title: "Trending",
                    description:
                      "Explore the Trending section to find the most rapidly moving cryptocurrencies and key market developments.",
                  },
                  {
                    title: "Watchlist",
                    description:
                      "Track and manage your favorite cryptocurrencies with ease using the Watchlist.",
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
                    className="p-8 rounded-lg border border-gray-700 bg-[#151D27] text-gray-300 shadow-lg"
                  >
                    <p className="font-bold text-xl text-[#00FFEA]">
                      {feature.title}
                    </p>
            ...
            {[
              {
                ...
                description:
                  "Get up-to-the-minute information on cryptocurrency prices and market trends.",
                link: "/trending",
              },
              {
                title: "Personal Watchlist",
                description:
                  "Add your favorite cryptocurrencies to your watchlist for easy tracking.",
                link: "/watchlist",
              },
              {
                title: "Explore Trends",
                description:
                  "Discover trending cryptocurrencies and market trends.",
                link: "/trending",
              },
              {
                title: "Secure and Reliable",
                description:
                  "We prioritize your security with advanced encryption and secure data storage.",
                link: "/security",
              },
            ].map((item, index) => (
              <div
                key={index}
                className="bg-[#1C2531] p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 flex flex-col justify-between"
              >
                <h2 className="text-2xl font-bold text-[#00FFEA] mb-4">
                  {item.title}
                </h2>
                <p className="text-gray-300 mb-4">{item.description}</p>
                <Link
                  to={item.link}
                  className="text-[#00FFEA] font-semibold"
                >
                  Learn More
                </Link>
              </div>
          ...
          <section className="bg-[#00FFEA] text-black text-center py-14 rounded-lg shadow-lg shadow-cyan-500/50">
            ...
            <p className="text-lg font-medium mb-6 max-w-2xl mx-auto">
              Sign up now and start tracking the latest cryptocurrency trends with ease. Join our community today!
            </p>
            <Link to="/signin">
              <button className="bg-black text-[#00FFEA] hover:bg-[#222] font-semibold py-4 px-8 rounded-lg text-lg transition-transform duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/50">
                Sign Up for Free
              </button>
            </Link>
          </section>
